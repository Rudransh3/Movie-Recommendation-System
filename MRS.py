...
# In[2]:
#Importing data to read from

credits_df = pd.read_csv("D:\\New folder (2)\\archive\\tmdb_5000_credits.csv")
movies_df = pd.read_csv("D:\\New folder (2)\\archive\\tmdb_5000_movies.csv")


# In[3]:

#Observing our data frame
movies_df.head()
...
#Extracting the relevant data and merging it into one column of the other data frame
...
# #Filtering the movies based on the demographics 
...
# In[14]:
#Function to generate recommendations related to a particular movie
...
print()
print("Recommendations for Harry Potter and the Half-Blood Prince")
print(get_recommendations("Harry Potter and the Half-Blood Prince"))
print()
print("Recommendations for Terminator 3: Rise of the Machines")
print(get_recommendations("Terminator 3: Rise of the Machines"))
...
print("Recommendations for Harry Potter and the Half-Blood Prince")
print(get_recommendations("Harry Potter and the Half-Blood Prince", cosine_sim2))
print()
print("Recommendations for Terminator 3: Rise of the Machines")
print(get_recommendations("Terminator 3: Rise of the Machines", cosine_sim2))
